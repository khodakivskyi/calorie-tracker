...
export default function SelectIngredientModal({
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-[1px] flex justify-center items-center z-[60]">
            <div className="bg-white p-6 rounded-2xl shadow-2xl border border-gray-100 w-[480px] max-h-[80vh] overflow-y-auto">
                <h3 className="text-xl font-bold mb-2">Select or create ingredient</h3>
