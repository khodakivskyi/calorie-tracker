...
import { getMealsByUserRequest } from "../store/slices/mealSlice.ts";
...
const mealTypes = [
    ...
    { id: 'dinner', type: 3, name: 'Dinner', imagePosition: 'right', imageUrl: Dinner },
    { id: 'snack', type: 4, name: 'Snack', imagePosition: 'left', imageUrl: Snack },
...
export default function AddMeal() {
    ...
    const hasMealOfTypeToday = (type: number) => {
        if (type === 5)  return false; //TODO: add snack
