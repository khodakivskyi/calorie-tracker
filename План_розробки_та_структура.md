...
- [ ] Налаштування GraphQL.NET та JWT middleware
- [ ] Тестування аутентифікації

#### День 4-5: Frontend аутентифікація
- [ ] Створення Redux slices для аутентифікації
...
- [ ] Реалізація редагування профілю (ім'я, email)
- [ ] Базова валідація даних профілю
...
#### День 6-7: Прогрес та статистика
- [ ] Створення ProgressChart компонента
- [ ] Реалізація відстеження калорій
